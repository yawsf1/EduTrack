    ...
    if(isset($_COOKIE['remember']) && !isset($_SESSION['id_client'])){
        ...
        if(!$stmt -> execute()){
            ...
            if($result -> num_rows > 0){
                ...
                header('Location: outils/flashcards.php?success');
                exit();
            }
            else{
...
<body>
    ...
    <div id="everything">
        ...
        <div id="content">
            <h1 id="bigtitle"> Cartes <span>Question/Réponse</span> </h1>
            <div class="container">
                <form action="../register.php" method="POST">
                    <div id="questions" class="question-answer">
                        <label for="question1">Entrer la Face avant (Une Question): </label>
                        <input type="text" id="question1" class="queswers" name="question" maxlength="120" required>
                    </div>
                    <div id="answers" class="question-answer">
                        <label for="question1">Entrer la Face arrière (Une Reponse):  </label>
                        <input type="text" id="reponse1" class="queswers" name="reponse" maxlength="120" required>
                    </div>
                    <div class="btnssss123">
                        <button class="enregistrer-question" name="examinez" type="submit">Enregistrer</button>
                        <a class="enregistrer-question" href="cartes.php" >Voir les autres cartes ? <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                </form>
            </div>        
        </div>
